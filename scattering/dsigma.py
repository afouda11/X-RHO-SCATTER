...
#Public        
    def Coherent_Elastic(self):
        ...
        np.savetxt("xy.txt", array)
        print("written xy.txt")
        data_dir = 'data_files'
        ...
        for k in self.method_list:
            ...
            for i,val in self.e_dict.items():
                ...
                for j in self.state_list:
                    ...
                    #parrelisation using multiple processes as python 
                    #multiprocessing can spread the function with different inputs across the cores this way, 
                    #maybe there's a more efficient multithreaded way...
